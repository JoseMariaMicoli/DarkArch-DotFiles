# Generated by Powerlevel10k configuration wizard on 2026-02-05 at 10:53 -03.
...
# --- ARREGLO DE CONTEXTO ---
  # Forzar que aparezca siempre
  typeset -g POWERLEVEL9K_CONTEXT_ALWAYS_SHOW=true

  # Configuración para ROOT (Fondo rojo, letras blancas)
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='root@darkarch'
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=160  # Rojo fuerte
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=255  # Blanco

  # Configuración para USUARIO NORMAL (xoce)
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_TEMPLATE='xoce@darkarch'
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_BACKGROUND=236 # Gris oscuro
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_FOREGROUND=250 # Gris claro

  # Esto elimina cualquier icono por defecto que esté rompiendo el diseño
  typeset -g POWERLEVEL9K_CONTEXT_VISUAL_IDENTIFIER_EXPANSION=''
  
  # IMPORTANTE: Sobreescribir estados vacíos
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_CONTENT_EXPANSION='xoce@darkarch'
